...
@router.get("/advanced", openapi_extra={
    "parameters": [
        ...
        {"name": "tag_ids", "in": "query", "required": False,
         "schema": {"type": "array", "items": {"type": "integer"}}, "style": "form", "explode": True},
        {"name": "match_mode", "in": "query", "required": False,
         "schema": {"type": "string", "enum": ["any", "all", "exact"]},
         "description": "Tag match mode for tag_ids: 'any' (default), 'all' (must include all), or 'exact' (must include all and no others)"},
        ...
        {"name": "igdb_tag_ids", "in": "query", "required": False,
         "schema": {"type": "array", "items": {"type": "integer"}}, "style": "form", "explode": True},
        {"name": "igdb_match_mode", "in": "query", "required": False,
         "schema": {"type": "string", "enum": ["any", "all", "exact"]},
         "description": "Tag match mode for igdb_tag_ids: 'any' (default), 'all' (must include all), or 'exact' (must include all and no others)"},
